...
- **Shipped (v0.1):** auth (BetterAuth + mandatory 2FA), invite flow, IAM, first-boot wizard, entities / persons / jurisdictions / periods / receipts domains, versioning engine, audit log, dev compose (postgres / minio / qdrant), Sentry.
