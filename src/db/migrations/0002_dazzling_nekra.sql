...
CREATE TABLE "entity_person_links" (
	...
	"metadata" jsonb DEFAULT '{}'::jsonb NOT NULL,
	CONSTRAINT "entity_person_links_share_percent_range" CHECK ("entity_person_links"."share_percent" IS NULL OR ("entity_person_links"."share_percent" >= 0 AND "entity_person_links"."share_percent" <= 100))
);
--> statement-breakpoint
